...
$("ion-icon#instagram").click(function() {
    window.open("http://www.instagram.com","_blanck");
})

$("ion-icon#twitter").click(function() {
    window.open("http://www.twitter.com","_blanck");
})

$("ion-icon#youtube").click(function() {
    window.open("http://www.youtube.com","_blanck");
})

$("ion-icon#linkedin").click(function() {
    window.open("http://www.linkedin.com","_blanck");
})
...
$('section#domingo-perfeito').waypoint( function(direcao) {
    if ( direcao == "down") {
        $('div.folha1').removeClass('animate__animated animate__fadeOutDown')
        $('div.folha3').removeClass('animate__animated animate__fadeOutDown')
        $('div.camarao').removeClass('animate__animated animate__fadeOutDown animate__slow')
        $('div.tomate').removeClass('animate__animated animate__fadeOutDown animate__slow')
        $('div.queijo').removeClass('animate__animated animate__fadeOutDown animate__slower')
        $('div.folha2').removeClass('animate__animated animate__fadeOutDown animate__slower')
    ...
    if ( direcao == "up") {
        ...
        $('div.camarao').addClass('animate__animated animate__fadeOutDown animate__slow')
        $('div.tomate').addClass('animate__animated animate__fadeOutDown animate__slow')
        $('div.queijo').addClass('animate__animated animate__fadeOutDown animate__slower')
        $('div.folha2').addClass('animate__animated animate__fadeOutDown animate__slower')
    } 
},{
    offset:'450px;'
})
...
$('section#pizza').waypoint( function(direcao) {
    if (direcao == 'down') {
        $('section#pizza p').removeClass('animate__animated animate__fadeOutDown')
        $('section#pizza div.pizza-opcoes').removeClass('animate__animated animate__fadeOutDown animate__slow')
    ...
    if(direcao == 'up') {
        $('section#pizza p').addClass('animate__animated animate__fadeOutDown')
        $('section#pizza div.pizza-opcoes').addClass('animate__animated animate__fadeOutDown animate__slow')
    }
...
$('section#testemunha').waypoint( function(direcao) {
    if (direcao == 'down') {
        $('div#testemunhos ul:eq(0)').removeClass('animate__animated animate__fadeOutDown animate__slower')
        $('div#testemunhos ul:eq(1)').removeClass('animate__animated animate__fadeOutDown animate__slow')
        $('div#testemunhos ul:eq(2)').removeClass('animate__animated animate__fadeOutDown animate__slower')
    ...
    if (direcao == 'up') {
        $('div#testemunhos ul:eq(0)').addClass('animate__animated animate__fadeOutDown animate__slower')
        $('div#testemunhos ul:eq(1)').addClass('animate__animated animate__fadeOutDown animate__slow')
        $('div#testemunhos ul:eq(2)').addClass('animate__animated animate__fadeOutDown animate__slower')
    }
...
$('section#plano-principal').waypoint( function(direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(1)').removeClass('animate__animated animate__fadeOutDown  animate__slow')
        ...
        $('div.planos:eq(1)').addClass('animate__animated animate__fadeOutDown  animate__slow')
